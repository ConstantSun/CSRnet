...
python train.py /home/nvhuy/hangdtth/hang/CSR_KD/shanghai_train_10_imgs.json  /home/nvhuy/hangdtth/hang/CSR_KD/shanghai_test_10_imgs.json --pre /home/nvhuy/hangdtth/hang/CSR_KD/PartAmodel_best.pth 0 0
"""
...
def main():
    ...
    student_model = CSRNet_student(cpr = args.cpr, convert_weight = '0')
    ...
    optimizer = torch.optim.Adam(student_model.parameters(), 
                                lr=args.original_lr, betas=(0.9, 0.999), 
                                eps=1e-1, 
                                weight_decay=0,
                                amsgrad=False)
    ...
    '''
    Convert weight from teacher to student for init student's weight (3 methods)
    '''
...
def train(train_list, teacher_model, student_model, criterion, optimizer, epoch):
    ...
    for i, (img, target) in enumerate(train_loader):
        ...
        print(f"target ****************************** TRAIN.PY: {target.shape}")
        ...
        if i % args.print_freq == 0:
            ...
            print("                                                                                                   accuracy: ", student_output.sum().data/target.sum().data*100, " % \n\n")
