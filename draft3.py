...
s_out = torch.randn(15).view(1,1,3,5)
target = torch.randn(20).view(1,1,4,5)
print("\n1)__________\n")
print(s_out,"\n", target)

# _h_min = torch.min(s_out.shape[2], target.shape[2]) + 1
# _w_min = torch.min(s_out.shape[3], target.shape[3]) + 1
